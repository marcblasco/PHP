<?php
    ...
    $error_message = '';
    $success_message = '';
     if(isset($_POST['codigo'], $_POST['titulo'], $_POST['categoria'], $_POST['precio'])) {
        $codigo = $_POST['codigo'];
        $titulo = $_POST['titulo'];
        ...
        $insercion = $pdo->prepare("INSERT INTO inmuebles(codigo, titulo, categoria, precio, habitaciones, localidad, descripcion)" .
